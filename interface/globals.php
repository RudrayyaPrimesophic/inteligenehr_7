...
// Mannual Globals
$GLOBALS['thumb_doc_max_size'] = 200;
$GLOBALS['facility_name'] = 'Psyclarity Health Massachusetts';
$GLOBALS['street'] = '163 Hamilton St';
$GLOBALS['city'] = 'Saugus';
$GLOBALS['state'] = 'MA';
$GLOBALS['postal_code'] = '01906';
$GLOBALS['country_code'] = 'US';
$GLOBALS['county'] = 'County name';
$GLOBALS['phone'] = '(855) 920-5310';


$GLOBALS['access_to_patient_status'] = ['RS Per Diem', 'Registered Nurse', 'Lead Registered Nurse', 'LPN Per Diem', 'LPN', 'RS Supervisor', 'CSS Clinical Supervisor', 'Administrators', 'Nursing Access'];
$GLOBALS['full_acl_groups'] = ['LPN', 'NURSING', 'Administrators', 'RS Per Diem', 'RN Per Diem', 'Registered Nurse', 'Lead Registered Nurse', 'LPN Per Diem', 'LPN', 'RS Supervisor', 'CSS Clinical Supervisor', 'Nursing Access'];
$GLOBALS['hide_patient_data_groups'] = ['RSS', 'CA'];
$GLOBALS['approved_by'] = ['77' => 'Flora Sadri-Azarbayejani, DO', '141' => 'Nicole White'];
//Access to continue meds button
$GLOBALS['access_to_continue_meds'] = ['npistone@psyclarityhealthma.com', 'flora', 'administrator'];

$GLOBALS['access_to_create_encounter'] = ['bgoldberg@psyclarityhealthma.com', 'administrator'];
//access to change level of care
$GLOBALS['access_to_change_lvl_care'] = ['bgoldberg@psyclarityhealthma.com', 'administrator'];
