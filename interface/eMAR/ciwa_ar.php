...
<div class="col-md-12">
				<table id="" class="table e_MAR_tb table-striped">
					...
					<tbody>
						<?php
						$sql_query = "SELECT id,date,pid,	  bp_systolic,bp_diastolic, temparature_pulse,pulse, respirations,o2_saturation, total_ciwa_score FROM `form_ciwa_cust` where pid = '" . $pid . "' order by date DESC";
