...
<body>
    <div class="container-fluid">
                        ...
                        <form action="rounds.php" id="interval_form" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    $pd_count_query = "SELECT count(*) as count FROM patient_data WHERE  admission_date <= CURRENT_DATE AND admission_date != '' AND (discharge_date ='' OR discharge_date > CURRENT_DATE)";
        ...
        <div class="patient_details">
            <?php
            $pd_query = "SELECT * FROM patient_data WHERE  admission_date <= CURRENT_DATE AND admission_date != '' AND (discharge_date ='' OR discharge_date > CURRENT_DATE)";
