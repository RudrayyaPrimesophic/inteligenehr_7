...
$pain_scale = $_REQUEST['pain_scale'];
...
$qry = "INSERT INTO `form_vitals`(`date`, `pid`, `user`, `groupname`, `authorized`, `activity`, `bps`, `bpd`, `weight`, `height`, `temperature`, `temp_method`, `pulse`, `respiration`, `note`, `BMI`, `BMI_status`, `waist_circ`, `head_circ`, `oxygen_saturation`, `glucose`, `external_id`, `intervention`,`reading`,`date_time`) VALUES ('$date1','$pid','$user','NULL','NULL','NULL','$bp_systolic','$bp_diastolic','$patient_weight','NULL','$temprature','NULL','$pulse','$respiration','$notes','$BMI','NULL','NULL','NULL','$o2_saturation','$reading','NULL','$intervention','$reading','$date1')";
...
if ($res != "") {
    ...
    $qry_nursing = "INSERT INTO `nursing_note`(`pid`,`shift_id`, `datetime`, `neuro_assessment`, `respiratory`, `appetite`, `gastrointestinal`, `musculoskeletal`, `complaints_of_pain`,`pain_scale`, `mental_health`, `suicide_thoughts`, `compliant_with`, `nursing_interventions_initiated`, `supportive_counseling`) VALUES ('$pid','$shift_id','$date1','$neuro_assessment','$respiratory','$appetite','$gastrointestinal','$musculoskeletal','$complaints_of_pain','$pain_scale','$mental_health','$suicide_thoughts','$compliant_with','$nursing_interventions_initiated','$supportive_counseling')";
    ...
    if ($res_nursing != "") {
        ...
        if ($res1 != "") {
            ...
            if ($suicide_thoughts == 'Currently Reports Suicidal thoughts or ideations') {
                @formJump("/interface/patient_file/encounter/load_form.php?formname=columbia_suicide_severity_rating_scale_and_scoring_instructions&group=1&shift_id=" . $shift_id);
            }
            include('rounds.php');
        } else {
